        ...
        nextStep: function() {
            if (step === 1) {
                ...
                <ul class="list-none space-y-2 pl-2 text-sm border-l-2 border-slate-600 ml-1">
                   <li>- Xét hai tam giác vuông $ABM$ và $ADM$ có: $AM$ là cạnh huyền chung <span class="float-right text-amber-400 font-bold">0.5đ</span></li>
                   <li>- $\\widehat{BAM} = \\widehat{DAM}$ (do $AM$ là phân giác) <span class="float-right text-amber-400 font-bold">0.25đ</span></li>
                ...
                <ul class="list-none space-y-2 pl-2 text-sm border-l-2 border-slate-600 ml-1">
                   <li>- Xét $\\Delta ACE$, ta có $CB \\perp AE$ và $ED \\perp AC$. Vậy $CB$ và $ED$ là hai đường cao. <span class="float-right text-amber-400 font-bold">0.5đ</span></li>
                   <li>- Chúng cắt nhau tại M $\\Rightarrow$ M là trực tâm $\\Delta ACE$. <span class="float-right text-amber-400 font-bold">0.25đ</span></li>
                   <li class="font-bold text-emerald-400 pt-1">- Do đó $AM$ là đường cao thứ ba, suy ra $AM \\perp CE$. <span class="float-right text-amber-400 font-bold">0.25đ</span></li>
                </ul>`;
                renderLog(baremB);
                step++;
            }
                ...
                <ul class="list-none space-y-2 pl-2 text-sm border-l-2 border-slate-600 ml-1">
                   <li>- Chứng minh $\\Delta MBE = \\Delta MDC$ $\\Rightarrow BE = DC$. <span class="float-right text-amber-400 font-bold">0.25đ</span></li>
                   <li class="font-bold text-emerald-400 pt-1">- Trong $\\Delta MDC$ vuông tại D, ta biện luận được góc $\\widehat{DMC} > \\widehat{C}$, suy ra cạnh $DC > MD$. Mà $BE = DC$, suy ra $BE > DM$. <span class="float-right text-amber-400 font-bold">0.25đ</span></li>
                </ul>`;
                renderLog(baremC);
                step++;
            }
