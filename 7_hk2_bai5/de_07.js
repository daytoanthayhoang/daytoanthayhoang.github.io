        ...
        nextStep: function() {
            if (step === 1) {
                ...
                <ul class="list-none space-y-2 pl-2 text-sm border-l-2 border-slate-600 ml-1">
                   <li>- Xét 2 tam giác vuông $ABD$ và $EBD$ có: $BD$ là cạnh huyền chung.</li>
                   <li>- $\\widehat{ABD} = \\widehat{EBD}$ (do $BD$ là phân giác).</li>
                ...
                <ul class="list-none space-y-2 pl-2 text-sm border-l-2 border-slate-600 ml-1">
                   ...
                   <li>- Xét $\\Delta ADM$ và $\\Delta EDC$ vuông tại A và E có: $AD = ED$, $\\widehat{ADM} = \\widehat{EDC}$ (đối đỉnh) $\\Rightarrow \\Delta ADM = \\Delta EDC \\Rightarrow AM = EC$.</li>
                   <li>- Ta có $BM = AB + AM$ và $BC = EB + EC \\Rightarrow BM = BC$.</li>
                ...
                <ul class="list-none space-y-2 pl-2 text-sm border-l-2 border-slate-600 ml-1">
                   <li>- Xét $\\Delta ADM$ vuông tại A. Cạnh huyền luôn lớn hơn cạnh góc vuông $\\Rightarrow DM < AD + AM$. (1)</li>
                   <li>- Mà $AM = EC$ (chứng minh từ câu b). (2)</li>
                   <li class="font-bold text-emerald-400">- Thay (2) vào (1) ta được: $DM < AD + EC$, hay $AD + EC > DM$.</li>
                </ul>`); step++;
            }
        }
    };
